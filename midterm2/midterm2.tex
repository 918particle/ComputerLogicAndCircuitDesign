...
\includegraphics[width=0.455\textwidth]{figures/adc_6.jpg} \hspace{0.25cm}
\includegraphics[width=0.455\textwidth]{figures/adc_3.jpg}
...
\begin{enumerate}
\item Consider Fig. \ref{adc:1}. (a) Determine the binary output codes from the 3-bit flash ADC in Fig. \ref{adc:1} (bottom left), given the input waveform in Fig. \ref{adc:1} (top left).  (b) Repeat (a), but for the input waveform in Fig. \ref{adc:1} (top right). \\ \vspace{3cm}
